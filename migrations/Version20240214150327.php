 ...
 */
final class Version20240214150327 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activite (id INT AUTO_INCREMENT NOT NULL, salle_id INT DEFAULT NULL, utilisateur_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, date DATETIME NOT NULL, nbr_max INT NOT NULL, coach VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, image_activte VARCHAR(255) NOT NULL, INDEX IDX_B8755515DC304035 (salle_id), INDEX IDX_B8755515FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
